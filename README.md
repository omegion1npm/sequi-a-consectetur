...
<a href="https://www.npmjs.com/package/@omegion1npm/sequi-a-consectetur">
  <img alt="npm version" src="https://img.shields.io/npm/v/@omegion1npm/sequi-a-consectetur.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@omegion1npm/sequi-a-consectetur">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@omegion1npm/sequi-a-consectetur.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @omegion1npm/sequi-a-consectetur
# using pnpm
pnpm install -D @omegion1npm/sequi-a-consectetur
# using yarn
yarn add --dev @omegion1npm/sequi-a-consectetur
```
...
```ts
import { svgSpritemap } from '@omegion1npm/sequi-a-consectetur';
